...
public class ServerActivity2 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intent = new Intent(getApplicationContext(),
				NodeJSToAndroidActivity.class);
		this.itemLst = new ArrayList<Item>();
		gv = (GridView) findViewById(R.id.gridView1);

		this.itemLst.add(new Item("Height", 6,
				R.drawable.elevation));
		this.itemLst.add(new Item("Barometer", 7,
		...
		this.itemLst.add(new Item("Noise",0, R.drawable.noise));
		// Internet
		...
		this.gv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (isOnline()) {
					...
					intent.putExtra("sensor", Integer.toString(i.getSensorType()));
